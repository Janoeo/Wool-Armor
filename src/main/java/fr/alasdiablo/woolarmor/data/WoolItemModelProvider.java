...
public class WoolItemModelProvider extends ItemModelProvider {

    private static final ResourceLocation GENERATED = new ResourceLocation("item/generated");

    public WoolItemModelProvider(DataGenerator generator, ExistingFileHelper existingFileHelper) {
