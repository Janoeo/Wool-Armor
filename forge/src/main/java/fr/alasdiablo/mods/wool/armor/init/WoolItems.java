...
public class WoolItems {
    static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, WoolArmorCommon.MOD_ID);
    ...
    public static class WoolArmorSet {
        private final RegistryObject<ArmorItem> helmetRegistryObject;
        private final RegistryObject<ArmorItem> chestplateRegistryObject;
        private final RegistryObject<ArmorItem> leggingsRegistryObject;
        private final RegistryObject<ArmorItem> bootsRegistryObject;
